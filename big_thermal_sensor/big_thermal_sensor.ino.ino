...
void tofSensorRoutine()
{
  while (!distanceSensor.checkForDataReady())
  {
    delay(1);
  }
  int distance = (distanceSensor.getDistance()) / 304.8; // Get the result of the measurement from the sensor
...
int counter;
double total_min_value;
double total_max_value;
double total_avg_value;
...
void loop(void)
{
  ...
  if (counter == 20) {
    Serial.print(total_min_value /= 20);
    Serial.print(",");
    Serial.print(total_max_value /= 20);
    Serial.print(",");
    Serial.print(total_avg_value /= 20);
    Serial.print(",");
    Serial.print(distance / 304.8);
    Serial.println();
  }
}
